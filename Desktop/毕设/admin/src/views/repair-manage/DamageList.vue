...
import { RepaitList, upstep, getPageInfo } from "@/api/repair-manage";
...
const getrepairList = async () => {
  const res = await RepaitList(useUser.UserInfo);
  console.log(useUser.UserInfo);
  console.log(res.data);
  repairList.value = res.data.datas;
...
const handlechange = async () => {
  ...
  const res = await getPageInfo({ createtime: DataValue.value,...useUser.UserInfo, });
  console.log(res.data);
  repairList.value = res.data.datas;
  count.value = res.data.total;
  getaddress();
